...
/* ============================================
   Footer — Section sombre, multi-colonnes
   Clean, sobre, style Uppbeat
   ============================================ */
...
export default function Footer() {
  return (
    <footer className="relative section-dark border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 sm:py-16 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          {footerData.columns.map((column, index) => (
            ...
            >
              <h4 className="text-sm font-semibold text-text-light mb-4 uppercase tracking-wider">
                {column.title}
              </h4>
